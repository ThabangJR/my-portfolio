      ...
      <div className="two-col" style={{ position: "relative", zIndex: 1 }}>
        ...
        <Reveal>
          ...
          <p style={{ fontSize: "0.96rem", lineHeight: 1.85, color: C.muted, marginBottom: 12 }}>
            ATS-optimised and ready to go — covers projects, skills, education, and everything you need to make a hiring decision.
          </p>

          {/* ── HOW TO ADD YOUR RESUME ─────────────────────────────
              1. Export your resume as a PDF (recommended) or keep .docx
              2. Rename it to: Thabang_Mohale_Resume.pdf
              3. Drop the file into the /public folder
              4. The download button below is already wired to RESUME_FILE
                 which is set in src/data/index.ts
          ───────────────────────────────────────────────────────── */}
